  ...
  return (
    <div className="relative w-full">
      ...
      <section className="relative h-screen w-full flex items-center justify-center text-white text-center px-4">
        ...
        <div className="z-10">
          {/* Teks kiri atas */}
          <h1 className="text-left text-xl md:text-2xl font-lexend] mb-2 md:ml-[-10%] md:mb-[-2%]">
            Selamat
            <br />
            datang !
          </h1>
      ...
      <section className="relative w-full min-h-screen py-32 md:pt-80 px-4 text-white">
        <div className="container mx-auto flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 max-w-6xl">
          ...
          {/* KANAN - Logo Image */}
          <div className="w-full md:w-1/2 flex md:pt-20 justify-center">
            <Image
      ...
      {/* Information Section */}
      <section className="relative w-full min-h-screen py-24 px-4 text-white">
        <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="font-museo text-sm md:text-2xl mb-12 leading-relaxed max-w-[80%]">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center justify-start pt-8 mt-12 md:mt-0">
      ...
      {/* Map Section */}
      <section className="relative w-full min-h-screen py-16 px-4 text-white">
      ...
      {/* Contact Section */}
      <section className="relative w-full min-h-screen pt-36 px-4 text-white">
        <div className="w-full max-w-6xl mx-auto px-4">
          {/* Heading */}
          <h2 className="font-league-spartan font-bold text-5xl mb-64">Kontak Kami</h2>

          {/* Grid Kontak */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-40 font-museo text-base leading-relaxed">
            {/* Kiri */}
            <div className="space-y-8">
              <div>
                <h3 className="font-lexend font-bold text-2xl mb-1">Telepon</h3>
                <p className="text-white/90 text-2xl">(7777-7777-7777)</p>
              </div>

              <div>
                <h3 className="font-lexend font-bold text-2xl mb-1">Alamat</h3>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="font-lexend font-bold text-2xl mb-1">Email</h3>
                <p className="text-white/90 text-2xl">teamduabelas1212@gmail.com</p>
              </div>

              <div>
                <h3 className="font-lexend font-bold text-2xl mb-1">Media Sosial</h3>
                <p className="text-white/90 text-2xl">Instagram Official : @k12emker</p>
              </div>
            </div>
          </div>
        </div>
